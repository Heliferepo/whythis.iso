...
iso_name=WhyThis
iso_label="WhyThis_$(date +%Y%m)"
iso_publisher="Mattis DALLEAU (Helife)"
iso_application="A minimalistic linux distribution"
...
make_efi() {
    ...
    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
        ...
        "${script_path}/efiboot/loader/entries/WhyThisiso-x86_64-usb.conf" > \
        "${work_dir}/iso/loader/entries/WhyThisiso-x86_64.conf"
...
make_efiboot() {
    ...
    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        "${script_path}/efiboot/loader/entries/WhyThisiso-x86_64-cd.conf" > \
        "${work_dir}/efiboot/loader/entries/WhyThisiso-x86_64.conf"
